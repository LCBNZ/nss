...
export function CreateVehicle({ heading, open, setOpen, formType = "create" }) {
  const createVehicleMutation = VehiclesApi.useCreateVehicle()
      ...
      <Formik
        ...
        onSubmit={async (values, { setSubmitting, resetForm }) => {
          ...
          const vehiclePayload = {
            ...
            hubo: values.hubo || "",
            ruc: values.ruc || "",
            rego_due: values.rego_due ? moment(values.rego_due).format("DD/MM/YYYY") : "",
            wof_due: values.wof_due ? moment(values.wof_due).format("DD/MM/YYYY") : "",
            service_due_date: values.service_due_date
              ? moment(values.service_due_date).format("DD/MM/YYYY")
              : "",
